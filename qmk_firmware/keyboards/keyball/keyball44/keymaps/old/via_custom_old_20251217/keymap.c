...
void process_combo_event(uint16_t combo_index, bool pressed) {
  if (pressed) {
    switch (combo_index) {
    case KL_BTN1: toggle_mouse_btn1(); break;
    case LS_BTN2: toggle_mouse_btn2(); break;
    case QW_ESC:  tap_code(KC_ESC); break;
    case MY_F7:   tap_code(KC_F7); break;
    case YU_F8:   tap_code(KC_F8); break;
    }
  }
}
#endif
